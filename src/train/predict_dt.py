...
def evaluate_dt(tree_model, X_test_list, y_test_list, data_file, X_imputed):
    ...
    print("DT -> Error absoluto medio (MAE):", average_mae)
    print("DT -> Error cuadrático medio (MSE):", average_mse)
    print("DT -> Error porcentaje absoluto medio (MAPE):", average_mape)
